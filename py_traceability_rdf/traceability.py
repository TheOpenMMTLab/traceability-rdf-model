...
class Traceability(DefinedNamespace):
    ...
    justifies: URIRef = ontology.get_object_property("#justifies")
    references: URIRef = ontology.get_object_property("#references")
    ...
    modality: URIRef = ontology.get_datatype_property("#modality")
    condition: URIRef = ontology.get_datatype_property("#condition")
