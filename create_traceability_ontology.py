...
g.add((NS.CodeModule, RDF.type, OWL.Class))
g.add((NS.CodeModule, RDFS.label, Literal("Code Module", lang='en')))
g.add((NS.CodeModule, RDFS.comment, Literal("A software implementation artifact such as a module, class, or function.", lang='en')))
g.add((NS.CodeModule, RDFS.subClassOf, NS.TraceableObject))
...
g.add((NS.programmingLanguage, RDF.type, OWL.DatatypeProperty))
g.add((NS.programmingLanguage, RDFS.domain, NS.CodeModule))
g.add((NS.programmingLanguage, RDFS.range, XSD.string))
g.add((NS.programmingLanguage, RDFS.label, Literal("Programming Language", lang='en')))
g.add((NS.programmingLanguage, RDFS.comment, Literal("Programming language of a code module.", lang='en')))

g.add((NS.modulePath, RDF.type, OWL.DatatypeProperty))
g.add((NS.modulePath, RDFS.domain, NS.CodeModule))
g.add((NS.modulePath, RDFS.range, XSD.string))
g.add((NS.modulePath, RDFS.label, Literal("Module Path", lang='en')))
g.add((NS.modulePath, RDFS.comment, Literal("Repository or file-system path of a code module.", lang='en')))
